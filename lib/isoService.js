...
var getISO31661alpha2Code = function(id, callback) {
    ...
    db.iso3166.find(query.getQueryDocument(id), function(err, docs) {
        docs.map(function(item) {
            delete item._id;
            return item;
        });
...
var getISO6391alpha2List = function(callback) {
    db.iso639.find(function(err, docs) {
        docs.map(function(item) {
            delete item._id;
            return item;
        });
...
var getISO6391alpha2Code = function(id, callback) {
    ...
    db.iso639.find(query.getQueryDocument(id), function(err, docs) {
        docs.map(function(item) {
            delete item._id;
            return item;
        });
...
module.exports = {
    ...
    getISO31661alpha2: getISO31661alpha2List,
